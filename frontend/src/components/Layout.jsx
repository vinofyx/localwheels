...
const NAV_MENUS = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Quote Management',  path: '/quotes' },
    ],
  },
  {
    name: 'Support',
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Dispatcher View',   path: '/tracking/dispatcher' },
      { name: 'AI Route Optimizer', path: '/routes/optimizer' },
      { name: 'Fleet Dashboard',    path: '/fleet/dashboard' },
      { name: 'Dispatch Center',    path: '/dispatch/center' },
      { name: 'Complaint Center',   path: '/complaints/center' },
      { name: 'Knowledge Base',     path: '/knowledge-base' },
      { name: 'Voice Assistant',    path: '/voice/assistant' },
      { name: 'Voice History',      path: '/voice/history' },
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'AI Sales Copilot', path: '/sales/copilot' },
    ],
  },
  {
    name: 'Fleet Intelligence',
    children: [
      { name: 'Fleet Dashboard',    path: '/maintenance' },
      { name: 'Live Telemetry',     path: '/maintenance/telemetry' },
      { name: 'Vehicle Health',     path: '/maintenance/vehicle-health' },
      { name: 'Maintenance AI',     path: '/maintenance/center' },
      { name: 'Work Orders',        path: '/maintenance/workorders' },
      { name: 'Workshops',          path: '/maintenance/workshops' },
      { name: 'Fuel Intelligence',  path: '/maintenance/fuel' },
      { name: 'Driver Behaviour',   path: '/maintenance/driver-behaviour' },
      { name: 'Battery Analytics',  path: '/maintenance/battery' },
      { name: 'Engine Analytics',   path: '/maintenance/engine' },
      { name: 'Tyre Analytics',     path: '/maintenance/tyres' },
    ],
  },
  {
    name: 'Business Intelligence',
    children: [
      { name: 'Executive Dashboard', path: '/bi/executive' },
      { name: 'BI Engine',           path: '/bi/intelligence' },
      { name: 'Forecast Engine',     path: '/bi/forecast' },
      { name: 'Financial Analytics', path: '/bi/financial' },
      { name: 'Operations Analytics',path: '/bi/operations' },
      { name: 'Customer Analytics',  path: '/bi/customers' },
      { name: 'Branch Analytics',    path: '/bi/branches' },
      { name: 'Alerts Center',       path: '/bi/alerts' },
      { name: 'Reports',             path: '/bi/reports' },
      { name: 'AI Copilot',          path: '/bi/copilot' },
    ],
  },
  {
    name: 'Documents',
    children: [
      { name: 'Doc Dashboard',   path: '/documents' },
      { name: 'Repository',      path: '/documents/repository' },
      { name: 'Upload Center',   path: '/documents/upload' },
      { name: 'Search',          path: '/documents/search' },
      { name: 'Validation',      path: '/documents/validation' },
      { name: 'Approvals',       path: '/documents/approval' },
      { name: 'Analytics',       path: '/documents/analytics' },
      { name: 'Recycle Bin',     path: '/documents/recycle-bin' },
    ],
  },
  {
    ...
    children: [
      ...
      { name: 'Driver Trips',      path: '/driver/trips' },
      { name: 'Digital POD',       path: '/driver/pod' },
      { name: 'Voice Commands',    path: '/driver/voice' },
      { name: 'Incident Reporting',path: '/driver/incidents' },
      { name: 'Driver Documents',  path: '/driver/documents' },
  ...
  },
  {
    name: 'Warehouse',
    children: [
      { name: 'WMS Dashboard',    path: '/warehouse' },
      { name: 'Setup & Master',   path: '/warehouse/master' },
      { name: 'Inventory',        path: '/warehouse/inventory' },
      { name: 'Inbound Center',   path: '/warehouse/inbound' },
      { name: 'Outbound Center',  path: '/warehouse/outbound' },
      { name: 'Tasks',            path: '/warehouse/tasks' },
      { name: 'AI Insights',      path: '/warehouse/ai' },
      { name: 'Dock Management',  path: '/warehouse/docks' },
      { name: 'Barcode Center',   path: '/warehouse/barcode' },
      { name: 'Analytics',        path: '/warehouse/analytics' },
      { name: 'Forecast',         path: '/warehouse/forecast' },
    ],
  },
  {
    name: 'Enterprise',
    children: [
      { name: 'Control Tower',     path: '/enterprise/control-tower' },
      { name: 'Global Operations', path: '/enterprise/operations' },
      { name: 'Suppliers',         path: '/enterprise/suppliers' },
      { name: 'Vendors',           path: '/enterprise/vendors' },
      { name: 'Purchase Orders',   path: '/enterprise/purchase-orders' },
      { name: 'Sales Orders',      path: '/enterprise/sales-orders' },
      { name: 'Incidents',         path: '/enterprise/incidents' },
      { name: 'Collaboration',     path: '/enterprise/collaboration' },
      { name: 'Risk Center',       path: '/enterprise/risk' },
      { name: 'AI Decisions',      path: '/enterprise/ai-decisions' },
      { name: 'Executive Cockpit', path: '/enterprise/cockpit' },
      { name: 'Customer Portal',   path: '/enterprise/customer-portal' },
      { name: 'Analytics',         path: '/enterprise/analytics' },
    ],
  },
  {
    name: 'Automation',
    children: [
      ...
      { name: 'Workflow Builder', path: '/automation/builder' },
      { name: 'Templates',        path: '/automation/templates' },
      { name: 'Designer',         path: '/automation/designer' },
      { name: 'Jobs',             path: '/automation/jobs' },
      { name: 'Execution History',path: '/automation/history' },
      { name: 'Monitoring',       path: '/automation/monitoring' },
      { name: 'Approvals',        path: '/automation/approvals' },
      { name: 'Digital Workers',  path: '/automation/workers' },
      { name: 'Scheduler',        path: '/automation/scheduler' },
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Invoice Center',      path: '/finance/invoices' },
      { name: 'Invoice Builder',     path: '/finance/invoices/new' },
      { name: 'Accounts Receivable', path: '/finance/ar' },
      { name: 'Accounts Payable',    path: '/finance/ap' },
      { name: 'Expense Center',      path: '/finance/expenses' },
      { name: 'Bank Reconciliation', path: '/finance/bank-recon' },
      { name: 'Cash Flow',           path: '/finance/cashflow' },
      { name: 'Budget Planner',      path: '/finance/budget' },
      { name: 'Cost Centers',        path: '/finance/cost-centers' },
      { name: 'Financial Forecast',  path: '/finance/forecast' },
      ...
      { name: 'Profit & Loss',       path: '/finance/pnl' },
      { name: 'Balance Sheet',       path: '/finance/balance-sheet' },
      { name: 'GST Dashboard',       path: '/finance/gst' },
      { name: 'Tax Management',      path: '/finance/tax' },
      { name: 'Finance Analytics',   path: '/finance/analytics' },
      { name: 'AI Finance Copilot',  path: '/finance/copilot' },
    ],
  },
  {
    name: 'Simulation',
    children: [
      { name: 'Digital Twin',        path: '/simulation' },
      { name: 'Simulation Center',   path: '/simulation/center' },
      { name: 'Scenario Builder',    path: '/simulation/scenario-builder' },
      { name: 'Scenario Library',    path: '/simulation/scenario-library' },
      { name: 'Autonomous Decisions',path: '/simulation/autonomous' },
      { name: 'Capacity Planning',   path: '/simulation/capacity' },
      { name: 'Demand Planning',     path: '/simulation/demand' },
      { name: 'Carbon Intelligence', path: '/simulation/carbon' },
      { name: 'Sustainability',      path: '/simulation/sustainability' },
      { name: 'Risk Simulation',     path: '/simulation/risk' },
      { name: 'Business Continuity', path: '/simulation/bcp' },
      { name: 'Recovery Center',     path: '/simulation/recovery' },
      { name: 'Sim Analytics',       path: '/simulation/analytics' },
      { name: 'Executive Center',    path: '/simulation/executive' },
      { name: 'AI Recommendations',  path: '/simulation/recommendations' },
    ],
  },
  {
    name: 'Integration',
    children: [
      { name: 'Dashboard',         path: '/integration' },
      { name: 'API Gateway',       path: '/integration/gateway' },
      { name: 'Webhooks',          path: '/integration/webhooks' },
      { name: 'API Keys',          path: '/integration/api-keys' },
      { name: 'Connectors',        path: '/integration/connectors' },
      { name: 'ERP Systems',       path: '/integration/erp' },
      { name: 'CRM Systems',       path: '/integration/crm' },
      { name: 'Accounting',        path: '/integration/accounting' },
      { name: 'Marketplaces',      path: '/integration/marketplace' },
      { name: 'Event Bus',         path: '/integration/events' },
      { name: 'Sync Engine',       path: '/integration/sync' },
      { name: 'OAuth Tokens',      path: '/integration/oauth' },
      { name: 'API Docs',          path: '/integration/api-docs' },
      { name: 'Analytics',         path: '/integration/analytics' },
      { name: 'Logs & Alerts',     path: '/integration/logs' },
      { name: 'Developer Portal',  path: '/integration/developer' },
    ],
  },
  {
    name: 'Switch',
