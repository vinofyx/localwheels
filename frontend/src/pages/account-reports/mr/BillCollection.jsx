...
// Bill Collection has a shorter filter list than MR Summary
const FILTER_OPTS = ['MR DATE', 'MR NO', 'PAYMENT MODE', 'PARTYNAME'];
...
const COLS = [
  'Bill No', 'Bill Date', 'Party Name', 'MR No', 'MR Date',
  'Payment Mode', 'TRN No', 'Bill Amt', 'Received Amt', 'TDS', 'Net Amt',
];
...
export default function BillCollection() {
  ...
  const handleSearch = () => {
    ...
    setSearched(true);
    setRows([]);
    toast('Loading Bill Collection…');
  };

  const isDate = filter === 'MR DATE';
