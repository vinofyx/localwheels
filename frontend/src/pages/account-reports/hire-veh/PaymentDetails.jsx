...
const FILTER_OPTS = [
  'PAYMENT DATE', 'PAYMENT TO', 'VEHICLE NO', 'PAY BRANCH', 'MEMO BRANCH',
];

const COLS = [
  'Pay No', 'Pay Date', 'Payment To', 'Vehicle No',
  'Memo No', 'Memo Date', 'From', 'To',
  'Pay Branch', 'Memo Branch',
  'Memo Freight', 'Advance', 'Balance', 'Pay Amount', 'TDS', 'Net Amount',
];
...
export default function PaymentDetails() {
  ...
  const handleSearch = () => {
    ...
    setSearched(true); setRows([]); toast('Loading Payment Details…');
  };
