...
const FILTERS = ['Expence No','Expence Date','Expence Head'];

export default function ModifyLRExpensesAny() {
  const [filter, setFilter] = useState('Expence No');
  const [value, setValue] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">LR Expenses(Any)</h2>
      </div>
