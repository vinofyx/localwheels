...
const FILTERS = ['BILLNO','BILL DATE','BRANCH','PARTY'];

export default function ModifyBillWithoutLRAny() {
  const [filter, setFilter] = useState('BILLNO');
  const [value, setValue] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">BillWithoutLR(Any)</h2>
      </div>
