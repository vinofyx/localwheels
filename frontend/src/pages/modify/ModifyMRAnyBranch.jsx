...
const FILTERS = ['MR NO','MR DATE','PARTYNAME'];

export default function ModifyMRAnyBranch() {
  const [filter, setFilter] = useState('MR NO');
  const [value, setValue] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">MR (Any Branch)</h2>
      </div>
