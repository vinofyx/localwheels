...
const FILTERS = ['LHS NO','LHS DATE','FROM OFFICE','TO OFFICE','VENDOR','VEHICLENO'];

export default function ModifyLHSAnyBranch() {
  const [filter, setFilter] = useState('LHS NO');
  const [value, setValue] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">LHS(Any Branch)</h2>
      </div>
