...
const FILTERS = ['MEMO NO','MEMO DATE','MEMO BRANCH','FROM','TO','VENDOR','VEHICLE NO'];

export default function ModifyMemo() {
  const [filter, setFilter] = useState('MEMO NO');
  const [value, setValue] = useState('');

  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Memo(Manifest)</h2>
      </div>
