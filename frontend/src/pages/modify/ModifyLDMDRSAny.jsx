...
const FILTERS = ['LDM NO','LDM DATE','DELIVERY','VENDOR','VEHICLE NO'];

export default function ModifyLDMDRSAny() {
  const [filter, setFilter] = useState('LDM NO');
  const [value, setValue] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">LDM/DRS(Any)</h2>
      </div>
