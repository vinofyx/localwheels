...
export default function LRCostAnalysis() {
  ...
  return (
    <div className="min-h-screen bg-white text-[13px]">
      ...
      <div className="text-center py-2">
        <span className="font-bold text-[14px] underline">LR Cost Analysis</span>
      </div>

      {/* Filter box */}
      <div className="border border-gray-300 rounded mx-3 mt-1 px-4 py-3 bg-gray-50">
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="border border-gray-300 px-2 py-1 text-[13px] bg-white focus:outline-none w-56"
          />
      ...
      {/* Results placeholder */}
      <div className="mx-3 mt-4 text-center text-gray-400 py-8">No data available</div>
    </div>
  );
}
