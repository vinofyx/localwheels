...
const FILTERS = ['LR DATE','LR NO','BOOKING BRANCH','DELIVERY BRANCH','CONSIGNOR','CONSIGNEE','VEHICLE NO'];
export default function NonSubmitPOD() {
  const [filter, setFilter] = useState('LR DATE');
  const [from, setFrom] = useState('');
  const [to, setTo] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2"><h2 className="font-bold text-[15px] tracking-wide underline">Non Submit POD</h2></div>
