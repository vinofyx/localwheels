...
const FILTERS = ['BILL DATE','BILL NO','CUSTOMER','BRANCH'];
export default function BillSubmission() {
  ...
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2"><h2 className="font-bold text-[15px] tracking-wide underline">Bill Submission Report</h2></div>
