...
const FILTERS = ['LR DATE','LR NO','BOOKING BRANCH','DELIVERY BRANCH','CONSIGNOR','CONSIGNEE'];

export default function PartialDispatchStock() {
  ...
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Partially Dispatch Stock</h2>
      </div>
