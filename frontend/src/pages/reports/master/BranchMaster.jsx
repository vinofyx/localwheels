...
const FILTERS = ['Branch Name','Branch Type','ZONE'];

export default function BranchMaster() {
  const [filter, setFilter] = useState('Branch Name');
  const [value, setValue] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Branch Master</h2>
      </div>
