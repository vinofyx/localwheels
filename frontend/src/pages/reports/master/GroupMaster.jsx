...
const FILTERS = ['GROUP NAME','UNDER GROUP NAME','NATURE'];

export default function GroupMaster() {
  const [filter, setFilter] = useState('GROUP NAME');
  const [value, setValue] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Group Master</h2>
      </div>
