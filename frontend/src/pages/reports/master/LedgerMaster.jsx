...
const FILTERS = ['Leadger Name','Group','Group Type'];

export default function LedgerMaster() {
  const [filter, setFilter] = useState('Leadger Name');
  const [value, setValue] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Ledger Master</h2>
      </div>
