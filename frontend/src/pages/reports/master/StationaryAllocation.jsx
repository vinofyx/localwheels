...
const FILTERS = ['BRANCH','ISSUE DATE','DOC TYPE'];

export default function StationaryAllocationReport() {
  const [filter, setFilter] = useState('BRANCH');
  const [value, setValue] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Stationary Allocation</h2>
      </div>
