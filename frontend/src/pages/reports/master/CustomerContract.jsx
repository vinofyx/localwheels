...
const FILTERS = ['BILLINGPARTY','LOCATION'];

export default function CustomerContractReport() {
  const [filter, setFilter] = useState('BILLINGPARTY');
  const [value, setValue] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Customer Contract</h2>
      </div>
