...
const FILTERS = ['LHS DATE','LHS NO','FROM OFFICE','TO OFFICE','VENDOR','VEHICLE NO'];

export default function LHSRegister() {
  const [filter, setFilter] = useState('LHS DATE');
  const [from, setFrom] = useState('');
  const [to, setTo] = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">LHS Register</h2>
      </div>
