...
const FILTERS = ['ENTRY DATE','RECEIPT DATE','PUMP VENDOR','VEHICLE NO','BRANCH','VEH OWNER TYPE','VEHICLE VENDOR NAME'];
  ...
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Diesel Statement</h2>
      </div>
