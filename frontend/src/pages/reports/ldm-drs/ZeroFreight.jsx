...
const FILTERS = ['DATE','LDM NO','BRANCH'];
export default function LdmDrsZeroFreight() {
  const [filter, setFilter] = useState(FILTERS[0]);
  const [from, setFrom]     = useState('');
  const [to, setTo]         = useState('');
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2"><h2 className="font-bold text-[15px] tracking-wide underline">LDM-DRS Zero Freight</h2></div>
