...
const FILTERS = ['LR DATE','DELIVERY BRANCH','LR NO','CONSIGNOR','CONSIGNEE','BOOKING BRANCH','VENDOR','VEHICLE NO'];

export default function DailyBranchInwardOutward() {
  ...
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Daily Branch Inward/Outward</h2>
      </div>
