...
const FILTERS = ['LR DATE','LR NO','CONSIGNOR','CONSIGNEE','BOOKING BRANCH'];

export default function PaidRegister() {
  ...
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Paid Register</h2>
      </div>
