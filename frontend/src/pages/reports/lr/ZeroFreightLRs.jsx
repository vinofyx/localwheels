...
const FILTERS = ['LR DATE','LR NO','BILLINGPARTY','BRANCH','BOOKING','DELIVERY','CONSIGNOR','CONSIGNEE','PAYTYPE','VEHICLE NO'];

export default function ZeroFreightLRs() {
  ...
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">Zero Freight LRs</h2>
      </div>
