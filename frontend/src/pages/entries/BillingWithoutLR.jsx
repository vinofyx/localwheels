...
export default function BillingWithoutLR() {
  ...
  const handleRefresh = () => {
    setBillingParty(''); setGstLiableTo('Not Applicable(N/A)'); setPoNo('');
    setManually(false); setBillNo('15'); setBillDate(getToday());
    setTotal(''); setCgst(''); setSgst(''); setIgst(''); setRoundUp(''); setBillAmount('');
    setRemarks(''); setChargeHead('--Select--'); setPkg(''); setUnit('KG');
    setRate(''); setChargeAmt(''); setCgstPct(''); setCgstAmt('');
    setSgstPct(''); setSgstAmt(''); setIgstPct(''); setIgstAmt('');
    setRemark(''); setChargeRows([]); setTableSearch('');
    ...
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#cfd6de' }}>
      ...
      <div className="bg-white rounded shadow-sm px-4 py-3 mb-2 overflow-x-auto">
        <div className="min-w-max">
          ...
          {/* Row 1: Billing Party | GST Liable To | Po No. */}
          ...
          {/* Row 2: Manually Bill No | Bill Date */}
          <div className="flex items-center gap-6 mb-3">
            <div className="flex items-center gap-2">
        ...
        <div className="min-w-max">
          ...
          <div className="flex items-center gap-1">
            ...
            <input value={rate} onChange={e => setRate(e.target.value)}
              className={`${inp} w-20`} />
            <input value={chargeAmt} onChange={e => setChargeAmt(e.target.value)}
              className={`${inp} w-28`} />
            <input value={cgstPct} onChange={e => setCgstPct(e.target.value)}
              className={`${inp} w-20`} />
            <input value={cgstAmt} onChange={e => setCgstAmt(e.target.value)}
              className={`${inp} w-20`} />
            <input value={sgstPct} onChange={e => setSgstPct(e.target.value)}
              className={`${inp} w-20`} />
            <input value={sgstAmt} onChange={e => setSgstAmt(e.target.value)}
              className={`${inp} w-20`} />
            <input value={igstPct} onChange={e => setIgstPct(e.target.value)}
              className={`${inp} w-20`} />
            <input value={igstAmt} onChange={e => setIgstAmt(e.target.value)}
              className={`${inp} w-20`} />
