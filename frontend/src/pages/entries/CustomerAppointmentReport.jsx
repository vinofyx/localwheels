...
const FILTERS = ['APPOINTMENT DATE','LR DATE','LR NO','DELIVERY BRANCH','CONSIGNOR','CONSIGNEE'];

export default function CustomerAppointmentReport() {
  const [filter, setFilter] = useState('APPOINTMENT DATE');
