...
const FILTER_OPTIONS = ['PAY NO', 'VEHICLE', 'MEMO DATE'];
...
export default function TripNotLinkToDiesel() {
  const [filter,  setFilter]  = useState('PAY NO');
  ...
  return (
    <div className="min-h-screen bg-white text-[13px]">
      ...
      <div className="text-center py-2">
        <span className="font-bold text-[15px] underline">TripNotLinkToDiesel</span>
      </div>
