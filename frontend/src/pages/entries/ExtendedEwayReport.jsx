...
const FILTERS = ['EXTENDED DATE','LR NO','LR DATE','EWB NO','EWAY BILL DATE','VALIDITY DATE'];

export default function ExtendedEwayReport() {
  const [filter, setFilter] = useState('EXTENDED DATE');
  ...
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">ExtendedEwayReport</h2>
      </div>
