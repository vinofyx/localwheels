...
const FILTER_OPTIONS = ['Entry No', 'Entry Date', 'Party', 'From', 'To'];
...
export default function MLOutstanding() {
  ...
  return (
    <div className="min-h-screen bg-white text-[13px]">
      ...
      <div className="text-center py-2">
        <span className="font-bold text-[15px] underline">ML_Oustanding</span>
      </div>
