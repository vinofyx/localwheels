...
const FILTERS = ['EWAY BILL DATE','LR DATE','EWB NO','EXTENDED DATE','LR NO','VALIDITY DATE'];

export default function EwayBillReport() {
  const [filter, setFilter] = useState('EWAY BILL DATE');
  ...
  return (
    <div className="p-3 min-h-screen text-[13px]" style={{ backgroundColor: '#dce9f5' }}>
      <div className="text-center mb-2">
        <h2 className="font-bold text-[15px] tracking-wide underline">E-Way Bill Report</h2>
      </div>
