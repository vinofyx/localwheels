...
const FILTER_OPTIONS = ['ENTRY NO', 'VEHICLE NO', 'ENTRY DATE', 'PARTY NAME', 'BRANCH', 'FROM LOCATION', 'TO LOCATION'];
...
export default function MarketLoadRegister() {
  const [filter,  setFilter]  = useState('ENTRY NO');
  ...
  return (
    <div className="min-h-screen bg-white text-[13px]">
      ...
      <div className="text-center py-2">
        <span className="font-bold text-[15px] underline">MarketLoad Register</span>
      </div>
