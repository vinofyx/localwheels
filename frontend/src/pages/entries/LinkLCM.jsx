...
const FILTER_OPTIONS = ['VEHICLE NO', 'LCM NO', 'LHS NO', 'FROM', 'TO'];
...
export default function LinkLCM() {
  const [filter, setFilter] = useState('VEHICLE NO');
  ...
  return (
    <div className="min-h-screen bg-white text-[13px]">
      ...
      <div className="text-center py-2">
        <span className="font-bold text-[15px] underline">Link LCM</span>
      </div>
