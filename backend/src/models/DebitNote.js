...
const s = new mongoose.Schema({
  ...
  debit_note_no: { type: String, required: true, trim: true, uppercase: true },
  dn_date:       { type: Date, default: Date.now },
...
s.index({ company_id: 1, debit_note_no: 1 }, { unique: true });
s.index({ company_id: 1, status: 1 });
module.exports = mongoose.model('DebitNote', s);
